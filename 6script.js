...
const movingItems = document.querySelectorAll(".shape, .dots, .comic-panel, .big-mark, .project-visual, .stage-hero, .stage-link, .swiss-index-row");

/* ===== portfolio return source: swiss style ===== */
const PORTFOLIO_RETURN_URL = "6index.html?page=2";
