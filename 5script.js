...
const movingItems = document.querySelectorAll(".shape, .dots, .comic-panel, .big-mark, .project-visual, .stage-hero, .stage-link, .luxury-showcase-card, .luxury-orb");

/* ===== portfolio return source: museum style ===== */
const PORTFOLIO_RETURN_URL = "5index.html?page=2";
