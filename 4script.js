...
const movingItems = document.querySelectorAll(".shape, .dots, .comic-panel, .big-mark, .project-visual, .stage-hero, .stage-link, .brutal-v2-black, .brutal-v2-red, .brutal-v2-yellow, .brutal-dispatch");

/* ===== portfolio return source: brutal style ===== */
const PORTFOLIO_RETURN_URL = "4index.html?page=2";
